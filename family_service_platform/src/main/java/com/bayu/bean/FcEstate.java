...
public class FcEstate implements Serializable {
    ...
    public FcEstate(Integer id, String estateCode, String estateName, String estateAddr, Double coverArea, Double buildArea, Double greenArea, Double roadArea, Double buildingNumber, String buildingLeader, String companyName, String companyBehalf, String contact, String contactPhone, String contactAddr, Double carSpaceDelayRate, Integer carSpaceOverDay, String estateType, Integer streetLampNumber, Integer hfcNum, String remark, String company) {
        this.id = id;
        this.estateCode = estateCode;
        this.estateName = estateName;
        this.estateAddr = estateAddr;
